...
export const ProductsEntitySchema = SchemaFactory.createForClass(ProductsEntity);

ProductsEntitySchema.pre('save', function (next: CallbackWithoutResultAndOptionalError) {
  next();
});
